...
> **Welcome to Product-Track Week 11, Task 7!**
...
| `src/perfUtils.py` | Main source code - **has bugs to fix** |
| `src/productCatalog.py` | Supporting code - **may also have bugs** |
| `tests/test_optimization.py` | Test file - **add your tests here** |
